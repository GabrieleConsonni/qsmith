...
Ogni scenario run e ogni invocazione API crea un contesto runtime isolato.
...
* [ ] Ogni `scenario_run` crea il proprio `RunContext`
* [ ] Ogni step aggiorna `context.last`
...
{
  "type": "run_scenario",
  "scenario_code": "SCN_PROCESS_ORDER",
  "init_vars": {
...
* crea una nuova `scenario_run`
* inizializza `vars` con `init_vars`
* esegue scenario in modo **asincrono**
...
* [ ] Collegare `invocation_id` alle scenario run
...
* [ ] Collegare invocation con scenario_runs
